...
require_relative "classis_active"
...
module Xmi
  module Uml13
    class AssociationClass < Shale::Mapper
      ...
      attribute :is_active, Shale::Type::String
      ...
      attribute :classifier_association_end, Shale::Type::Value
      ...
      attribute :association_association_end, Shale::Type::Value
      ...
      attribute :class_is_active, ClassisActive, collection: true
      ...
      xml do
        ...
        map_attribute "Classifier.associationEnd", to: :classifier_association_end
        ...
        map_attribute "Association.associationEnd", to: :association_association_end
        ...
        map_element "Class.isActive", to: :class_is_active
