...
require_relative 'attributeassociation_end'
require_relative 'attributeattribute_link'
require_relative 'attributeinitial_value'
...
class Attribute < Shale::Mapper
  ...
  attribute :attribute_initial_value, AttributeinitialValue, collection: true
  ...
  attribute :attribute_association_end, AttributeassociationEnd, collection: true
  attribute :attribute_attribute_link, AttributeattributeLink, collection: true
  ...
  xml do
    ...
    map_element 'Attribute.initialValue', to: :attribute_initial_value
    ...
    map_element 'Attribute.associationEnd', to: :attribute_association_end
    map_element 'Attribute.attributeLink', to: :attribute_attribute_link
