...
require_relative 'attribute_linkattribute'
require_relative 'attribute_linkinstance'
require_relative 'attribute_linkvalue'
...
class AttributeLink < Shale::Mapper
  ...
  attribute :attribute, Shale::Type::Value
  ...
  attribute :attribute_link_instance, AttributeLinkinstance, collection: true
  attribute :attribute_link_attribute, AttributeLinkattribute, collection: true
  attribute :attribute_link_value, AttributeLinkvalue, collection: true
  ...
  xml do
    ...
    map_element 'AttributeLink.instance', to: :attribute_link_instance
    map_element 'AttributeLink.attribute', to: :attribute_link_attribute
    map_element 'AttributeLink.value', to: :attribute_link_value
