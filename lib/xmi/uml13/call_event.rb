...
require_relative 'call_eventoperation'
...
class CallEvent < Shale::Mapper
  ...
  attribute :operation, Shale::Type::Value
  ...
  attribute :call_event_operation, CallEventoperation, collection: true
  ...
  xml do
    ...
    map_attribute 'operation', to: :operation
    ...
    map_element 'CallEvent.operation', to: :call_event_operation
