...
require_relative 'change_eventchange_expression'
...
class ChangeEvent < Shale::Mapper
  ...
  attribute :change_event_change_expression, ChangeEventchangeExpression, collection: true
  ...
  xml do
    ...
    map_element 'ChangeEvent.changeExpression', to: :change_event_change_expression
