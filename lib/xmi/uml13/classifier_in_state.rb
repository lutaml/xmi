...
require_relative 'classifier_in_statein_state'
require_relative 'classifier_in_stateobject_flow_state'
require_relative 'classifier_in_statetype'
...
class ClassifierInState < Shale::Mapper
  ...
  attribute :object_flow_state, Shale::Type::Value
  attribute :in_state, Shale::Type::Value
  ...
  attribute :classifier_in_state_object_flow_state, ClassifierInStateobjectFlowState, collection: true
  attribute :classifier_in_state_in_state, ClassifierInStateinState, collection: true
  attribute :classifier_in_state_type, ClassifierInStatetype, collection: true
  ...
  xml do
    ...
    map_attribute 'objectFlowState', to: :object_flow_state
    map_attribute 'inState', to: :in_state
    ...
    map_element 'ClassifierInState.objectFlowState', to: :classifier_in_state_object_flow_state
    map_element 'ClassifierInState.inState', to: :classifier_in_state_in_state
    map_element 'ClassifierInState.type', to: :classifier_in_state_type
