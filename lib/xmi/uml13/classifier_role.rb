...
require_relative "classifier_roleassociation_end_role"
require_relative "classifier_roleavailable_feature"
require_relative "classifier_rolebase"
require_relative "classifier_rolemessage"
require_relative "classifier_rolemessage2"
require_relative "classifier_rolemultiplicity"
...
class ClassifierRole < Shale::Mapper
  ...
  xml do
    ...
    map_attribute "ClassifierRole.namespace", to: :classifier_role_namespace
    map_attribute "message2", to: :message2
    map_attribute "message", to: :message
    map_attribute "base", to: :base
    map_attribute "availableFeature", to: :available_feature
