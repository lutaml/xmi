...
require_relative "componentdeployment"
require_relative "componentimplements"
...
class Component < Shale::Mapper
  ...
  attribute :deployment, Shale::Type::Value
  attribute :implements, Shale::Type::Value
  ...
  attribute :component_deployment, Componentdeployment, collection: true
  attribute :component_implements, Componentimplements, collection: true
  ...
  xml do
    ...
    map_attribute "deployment", to: :deployment
    map_attribute "implements", to: :implements
    ...
    map_element "Component.deployment", to: :component_deployment
    map_element "Component.implements", to: :component_implements
