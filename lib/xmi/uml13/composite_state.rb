...
require_relative "composite_stateis_concurrent"
require_relative "composite_statesubstate"
...
module Xmi
  module Uml13
    class CompositeState < Shale::Mapper
      attribute :name, Shale::Type::Value
      attribute :visibility, Shale::Type::String
      attribute :is_concurrent, Shale::Type::String
      ...
      xml do
        ...
        map_attribute "isConcurrent", to: :is_concurrent
        ...
        map_element "CompositeState.substate", to: :composite_state_substate
      end
    end
  end
end
