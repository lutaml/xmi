...
require_relative "actionaction_sequence"
require_relative "actionactual_argument"
require_relative "actionis_asynchronous"
require_relative "actionmessage"
require_relative "actionrecurrence"
require_relative "actionrequest"
require_relative "actionscript"
require_relative "actiontarget"
require_relative "create_actioninstantiation"
...
class CreateAction < Shale::Mapper
  attribute :name, Shale::Type::Value
  attribute :visibility, Shale::Type::String
  attribute :is_asynchronous, Shale::Type::String
  attribute :script, Shale::Type::Value
  ...
  attribute :request, Shale::Type::Value
  attribute :message, Shale::Type::Value
  attribute :action_sequence, Shale::Type::Value
  attribute :instantiation, Shale::Type::Value
  ...
  attribute :action_recurrence, Actionrecurrence, collection: true
  attribute :action_target, Actiontarget, collection: true
  attribute :action_is_asynchronous, ActionisAsynchronous, collection: true
  attribute :action_script, Actionscript, collection: true
  ...
  attribute :action_request, Actionrequest, collection: true
  attribute :action_message, Actionmessage, collection: true
  attribute :action_action_sequence, ActionactionSequence, collection: true
  attribute :create_action_instantiation, CreateActioninstantiation, collection: true
  attribute :model_element_tagged_value, ModelElementtaggedValue, collection: true
  attribute :action_actual_argument, ActionactualArgument, collection: true
  ...
  xml do
    ...
    map_attribute "isAsynchronous", to: :is_asynchronous
    ...
    map_attribute "request", to: :request
    map_attribute "message", to: :message
    map_attribute "actionSequence", to: :action_sequence
    map_attribute "instantiation", to: :instantiation
    ...
    map_element "Action.recurrence", to: :action_recurrence
    map_element "Action.target", to: :action_target
    map_element "Action.isAsynchronous", to: :action_is_asynchronous
    map_element "Action.script", to: :action_script
    ...
    map_element "Action.request", to: :action_request
    map_element "Action.message", to: :action_message
    map_element "Action.actionSequence", to: :action_action_sequence
    map_element "CreateAction.instantiation", to: :create_action_instantiation
    map_element "ModelElement.taggedValue", to: :model_element_tagged_value
    map_element "Action.actualArgument", to: :action_actual_argument
  end
end
