...
require_relative "generalizationdiscriminator"
require_relative "generalizationsubtype"
require_relative "generalizationsupertype"
...
module Xmi
  module Uml13
    class Generalization < Shale::Mapper
      ...
      attribute :discriminator, Shale::Type::Value
      ...
      attribute :subtype, Shale::Type::Value
      attribute :supertype, Shale::Type::Value
      ...
      attribute :generalization_discriminator, Generalizationdiscriminator, collection: true
      ...
      attribute :generalization_subtype, Generalizationsubtype, collection: true
      attribute :generalization_supertype, Generalizationsupertype, collection: true
      ...
      xml do
        ...
        map_attribute "discriminator", to: :discriminator
        ...
        map_attribute "supertype", to: :supertype
        ...
        map_element "Generalization.discriminator", to: :generalization_discriminator
        ...
        map_element "Generalization.subtype", to: :generalization_subtype
        map_element "Generalization.supertype", to: :generalization_supertype
