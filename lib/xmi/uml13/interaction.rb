...
require_relative "interactioncontext"
require_relative "interactionmessage"
...
module Xmi
  module Uml13
    class Interaction < Shale::Mapper
      ...
      attribute :interaction_context, Interactioncontext, collection: true
      attribute :model_element_tagged_value, ModelElementtaggedValue, collection: true
      attribute :interaction_message, Interactionmessage, collection: true
      ...
      xml do
        ...
        map_element "Interaction.context", to: :interaction_context
        map_element "ModelElement.taggedValue", to: :model_element_tagged_value
        map_element "Interaction.message", to: :interaction_message
      end
    end
  end
end
