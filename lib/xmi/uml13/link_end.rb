...
require_relative 'link_endassociation_end'
require_relative 'link_endinstance'
require_relative 'link_endlink'
...
class LinkEnd < Shale::Mapper
  ...
  attribute :link_end_link, LinkEndlink, collection: true
  attribute :link_end_association_end, LinkEndassociationEnd, collection: true
  attribute :link_end_instance, LinkEndinstance, collection: true
  ...
  xml do
    ...
    map_element 'LinkEnd.link', to: :link_end_link
    map_element 'LinkEnd.associationEnd', to: :link_end_association_end
    map_element 'LinkEnd.instance', to: :link_end_instance
