...
require_relative "message_instanceargument"
require_relative "message_instancereceiver"
require_relative "message_instancesender"
require_relative "message_instancespecification"
...
module Xmi
  module Uml13
    class MessageInstance < Shale::Mapper
      ...
      attribute :argument, Shale::Type::Value
      ...
      attribute :message_instance_specification, MessageInstancespecification, collection: true
      attribute :message_instance_sender, MessageInstancesender, collection: true
      attribute :message_instance_receiver, MessageInstancereceiver, collection: true
      attribute :message_instance_argument, MessageInstanceargument, collection: true
      attribute :model_element_tagged_value, ModelElementtaggedValue, collection: true

      xml do
        root "MessageInstance"
        ...
        map_attribute "argument", to: :argument
        ...
        map_element "MessageInstance.specification", to: :message_instance_specification
        map_element "MessageInstance.sender", to: :message_instance_sender
        map_element "MessageInstance.receiver", to: :message_instance_receiver
        map_element "MessageInstance.argument", to: :message_instance_argument
