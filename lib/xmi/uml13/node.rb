...
require_relative 'nodecomponent'
...
class Node < Shale::Mapper
  ...
  attribute :component, Shale::Type::Value
  ...
  attribute :node_component, Nodecomponent, collection: true
  ...
  xml do
    ...
    map_attribute 'component', to: :component
    ...
    map_element 'Node.component', to: :node_component
