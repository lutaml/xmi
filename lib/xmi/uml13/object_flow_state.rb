...
require_relative "object_flow_statetype_state"
require_relative "state_vertexincoming"
require_relative "state_vertexoutgoing"
require_relative "state_vertexparent"
require_relative "stateclassifier_in_state"
require_relative "statedeferred_event"
require_relative "stateentry"
require_relative "stateexit"
require_relative "stateinternal_transition"
require_relative "statestate_machine"
require_relative "xm_iextension"

module Xmi
  module Uml13
    class ObjectFlowState < Shale::Mapper
      ...
      attribute :state_machine, Shale::Type::Value
      attribute :deferred_event, Shale::Type::Value
      attribute :classifier_in_state, Shale::Type::Value
      attribute :type_state, Shale::Type::Value
      ...
      attribute :object_flow_state_type_state, ObjectFlowStatetypeState, collection: true
      ...
      xml do
        ...
        map_attribute "stateMachine", to: :state_machine
        map_attribute "deferredEvent", to: :deferred_event
        map_attribute "classifierInState", to: :classifier_in_state
        map_attribute "typeState", to: :type_state
        ...
        map_element "State.stateMachine", to: :state_state_machine
        map_element "State.deferredEvent", to: :state_deferred_event
        map_element "State.classifierInState", to: :state_classifier_in_state
        map_element "ObjectFlowState.typeState", to: :object_flow_state_type_state
        map_element "ModelElement.taggedValue", to: :model_element_tagged_value
        map_element "State.internalTransition", to: :state_internal_transition
        map_element "State.entry", to: :state_entry
        map_element "State.exit", to: :state_exit
      end
    end
  end
end
