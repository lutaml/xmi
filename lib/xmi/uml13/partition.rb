...
class Partition < Shale::Mapper
  ...
  attribute :contents, Shale::Type::Value
  attribute :activity_model, Shale::Type::Value
  ...
  attribute :partition_contents, Partitioncontents, collection: true
  attribute :partition_activity_model, PartitionactivityModel, collection: true
  ...
  xml do
    ...
    map_attribute 'activityModel', to: :activity_model
    ...
    map_element 'Partition.contents', to: :partition_contents
    map_element 'Partition.activityModel', to: :partition_activity_model
