...
require_relative "receptionis_polymorphic"
require_relative "receptionsignal"
require_relative "receptionspecification"
require_relative "xm_iextension"

module Xmi
  module Uml13
    class Reception < Shale::Mapper
      ...
      attribute :reception_is_polymorphic, ReceptionisPolymorphic, collection: true
      attribute :reception_specification, Receptionspecification, collection: true
      ...
      attribute :reception_signal, Receptionsignal, collection: true
      ...
      xml do
        ...
        map_element "Reception.isPolymorphic", to: :reception_is_polymorphic
        map_element "Reception.specification", to: :reception_specification
        ...
        map_element "Reception.signal", to: :reception_signal
