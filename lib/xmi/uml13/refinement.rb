...
require_relative 'dependencyclient'
require_relative 'dependencydescription'
require_relative 'dependencyowning_dependency'
require_relative 'dependencysub_dependencies'
require_relative 'dependencysupplier'
...
require_relative 'refinementmapping'
require_relative 'xm_iextension'

class Refinement < Shale::Mapper
  attribute :name, Shale::Type::Value
  attribute :visibility, Shale::Type::String
  attribute :description, Shale::Type::Value
  ...
  attribute :owning_dependency, Shale::Type::Value
  attribute :client, Shale::Type::Value
  attribute :supplier, Shale::Type::Value
  ...
  attribute :dependency_description, Dependencydescription, collection: true
  attribute :refinement_mapping, Refinementmapping, collection: true
  ...
  attribute :dependency_owning_dependency, DependencyowningDependency, collection: true
  attribute :dependency_client, Dependencyclient, collection: true
  attribute :dependency_supplier, Dependencysupplier, collection: true
  attribute :model_element_tagged_value, ModelElementtaggedValue, collection: true
  attribute :dependency_sub_dependencies, DependencysubDependencies, collection: true
  ...
  xml do
    ...
    map_attribute 'owningDependency', to: :owning_dependency
    ...
    map_element 'Dependency.description', to: :dependency_description
    map_element 'Refinement.mapping', to: :refinement_mapping
    ...
    map_element 'Dependency.owningDependency', to: :dependency_owning_dependency
    map_element 'Dependency.client', to: :dependency_client
    map_element 'Dependency.supplier', to: :dependency_supplier
    map_element 'ModelElement.taggedValue', to: :model_element_tagged_value
    map_element 'Dependency.subDependencies', to: :dependency_sub_dependencies
  end
end
