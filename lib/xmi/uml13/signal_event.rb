...
require_relative 'signal_eventsignal'
require_relative 'xm_iextension'

class SignalEvent < Shale::Mapper
  ...
  attribute :signal_event_signal, SignalEventsignal, collection: true
  ...
  xml do
    ...
    map_element 'SignalEvent.signal', to: :signal_event_signal
