...
module Xmi
  module Uml13
    class SubmachineState < Shale::Mapper
      ...
      attribute :state_state_machine, Shale::Type::Value
      attribute :deferred_event, Shale::Type::Value
      attribute :classifier_in_state, Shale::Type::Value
      attribute :submachine_state_state_machine, Shale::Type::Value
      ...
      xml do
        ...
        map_attribute "State.stateMachine", to: :state_state_machine
        map_attribute "deferredEvent", to: :deferred_event
        map_attribute "classifierInState", to: :classifier_in_state
        map_attribute "SubmachineState.stateMachine", to: :submachine_state_state_machine
