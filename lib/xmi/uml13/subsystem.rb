...
require_relative "subsystemis_instantiable"
require_relative "xm_iextension"

module Xmi
  module Uml13
    class Subsystem < Shale::Mapper
      ...
      attribute :is_instantiable, Shale::Type::String
      ...
      attribute :model_element_element_reference, Shale::Type::Value
      ...
      attribute :package_element_reference, Shale::Type::Value
      ...
      attribute :subsystem_is_instantiable, SubsystemisInstantiable, collection: true
      ...
      xml do
        ...
        map_attribute "isInstantiable", to: :is_instantiable
        ...
        map_attribute "ModelElement.elementReference", to: :model_element_element_reference
        ...
        map_attribute "Package.elementReference", to: :package_element_reference
        ...
        map_element "Subsystem.isInstantiable", to: :subsystem_is_instantiable
