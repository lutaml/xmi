...
require_relative "time_eventduration"
require_relative "xm_iextension"

class TimeEvent < Shale::Mapper
  ...
  attribute :time_event_duration, TimeEventduration, collection: true
  ...
  xml do
    ...
    map_element "TimeEvent.duration", to: :time_event_duration
