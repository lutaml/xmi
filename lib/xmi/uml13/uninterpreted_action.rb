...
require_relative 'uninterpreted_actionbody'
require_relative 'xm_iextension'

class UninterpretedAction < Shale::Mapper
  ...
  attribute :uninterpreted_action_body, UninterpretedActionbody, collection: true
  ...
  xml do
    ...
    map_element 'UninterpretedAction.body', to: :uninterpreted_action_body
