...
require_relative "activity_modelpartition"
...
require_relative "state_machinecontext"
require_relative "state_machinesubmachine_state"
require_relative "state_machinetop"
require_relative "state_machinetransitions"
require_relative "xm_iextension"

class ActivityModel < Shale::Mapper
  ...
  attribute :submachine_state, Shale::Type::Value
  ...
  attribute :activity_model_partition, ActivityModelpartition, collection: true
  ...
  xml do
    ...
    map_attribute "submachineState", to: :submachine_state
    ...
    map_element "ActivityModel.partition", to: :activity_model_partition
  end
end
