...
class AssociationEndRole < Shale::Mapper
  ...
  attribute :association_role, Shale::Type::Value
  ...
  attribute :association_end_is_navigable, AssociationEndisNavigable,
            collection: true
  attribute :association_end_is_ordered, AssociationEndisOrdered,
            collection: true
  attribute :association_end_aggregation, AssociationEndaggregation,
            collection: true
  attribute :association_end_multiplicity, AssociationEndmultiplicity,
            collection: true
  attribute :association_end_changeable, AssociationEndchangeable,
            collection: true
  attribute :association_end_target_scope, AssociationEndtargetScope,
            collection: true
  ...
  attribute :association_end_specification, AssociationEndspecification,
            collection: true
  attribute :association_end_association, AssociationEndassociation,
            collection: true
  attribute :association_end_link_end, AssociationEndlinkEnd, collection: true
  attribute :association_end_association_end_role,
            AssociationEndassociationEndRole, collection: true
  attribute :association_end_role_association_role,
            AssociationEndRoleassociationRole, collection: true
  attribute :association_end_role_base, AssociationEndRolebase, collection: true
  attribute :model_element_tagged_value, ModelElementtaggedValue,
            collection: true
  attribute :association_end_qualifier, AssociationEndqualifier,
            collection: true
  ...
  xml do
    ...
    map_element "AssociationEnd.specification",
                to: :association_end_specification
    ...
    map_element "AssociationEnd.associationEndRole",
                to: :association_end_association_end_role
    map_element "AssociationEndRole.associationRole",
                to: :association_end_role_association_role
