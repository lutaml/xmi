...
class AssociationRole < Shale::Mapper
  ...
  attribute :generalizable_element_is_abstract, GeneralizableElementisAbstract,
            collection: true
  attribute :association_role_multiplicity, AssociationRolemultiplicity,
            collection: true
  ...
  attribute :association_association_end, AssociationassociationEnd,
            collection: true
  ...
  xml do
    ...
    map_element "AssociationRole.multiplicity",
                to: :association_role_multiplicity
