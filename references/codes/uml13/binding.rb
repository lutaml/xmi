...
require_relative "bindingargument"
...
class Binding < Shale::Mapper
  ...
  attribute :binding_argument, Bindingargument, collection: true
  ...
  xml do
    ...
    map_element "Binding.argument", to: :binding_argument
  end
end
