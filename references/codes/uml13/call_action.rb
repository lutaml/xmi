...
require_relative "call_actionmode"
...
class CallAction < Shale::Mapper
  ...
  attribute :mode, Shale::Type::String
  ...
  attribute :call_action_mode, CallActionmode, collection: true
  ...
  xml do
    ...
    map_element "CallAction.mode", to: :call_action_mode
