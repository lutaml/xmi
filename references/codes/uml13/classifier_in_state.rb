...
class ClassifierInState < Shale::Mapper
  ...
  attribute :classifier_classifier_in_state, ClassifierclassifierInState,
            collection: true
  attribute :classifier_in_state_object_flow_state,
            ClassifierInStateobjectFlowState, collection: true
  attribute :classifier_in_state_in_state, ClassifierInStateinState,
            collection: true
  ...
  xml do
    ...
    map_element "ClassifierInState.objectFlowState",
                to: :classifier_in_state_object_flow_state
