...
class Collaboration < Shale::Mapper
  ...
  attribute :collaboration_represented_classifier,
            CollaborationrepresentedClassifier, collection: true
  attribute :collaboration_represented_operation,
            CollaborationrepresentedOperation, collection: true
  attribute :collaboration_constraining_element,
            CollaborationconstrainingElement, collection: true
  ...
  attribute :collaboration_interaction, Collaborationinteraction,
            collection: true
  ...
  xml do
    ...
    map_element "Collaboration.representedClassifier",
                to: :collaboration_represented_classifier
    map_element "Collaboration.representedOperation",
                to: :collaboration_represented_operation
    map_element "Collaboration.constrainingElement",
                to: :collaboration_constraining_element
