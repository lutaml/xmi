...
class Constraint < Shale::Mapper
  ...
  attribute :constraint_constrained_element, ConstraintconstrainedElement,
            collection: true
  attribute :constraint_constrained_stereotype,
            ConstraintconstrainedStereotype, collection: true
  ...
  xml do
    ...
    map_element "Constraint.constrainedElement",
                to: :constraint_constrained_element
    map_element "Constraint.constrainedStereotype",
                to: :constraint_constrained_stereotype
