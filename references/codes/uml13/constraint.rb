...
require_relative "constraintbody"
require_relative "constraintconstrained_element"
require_relative "constraintconstrained_stereotype"
...
class Constraint < Shale::Mapper
  ...
  attribute :constrained_element, Shale::Type::Value
  attribute :constrained_stereotype, Shale::Type::Value
  ...
  attribute :constraint_body, Constraintbody, collection: true
  ...
  attribute :constraint_constrained_element, ConstraintconstrainedElement, collection: true
  attribute :constraint_constrained_stereotype, ConstraintconstrainedStereotype, collection: true
  ...
  xml do
    ...
    map_attribute "constrainedElement", to: :constrained_element
    map_attribute "constrainedStereotype", to: :constrained_stereotype
    ...
    map_element "Constraint.body", to: :constraint_body
    ...
    map_element "Constraint.constrainedElement", to: :constraint_constrained_element
    map_element "Constraint.constrainedStereotype", to: :constraint_constrained_stereotype
