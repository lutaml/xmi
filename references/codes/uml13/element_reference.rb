...
class ElementReference < Shale::Mapper
  ...
  attribute :element_reference_visibility, ElementReferencevisibility,
            collection: true
  ...
  attribute :element_reference_referenced_element,
            ElementReferencereferencedElement, collection: true
  attribute :element_reference_package, ElementReferencepackage,
            collection: true
  ...
  xml do
    ...
    map_element "ElementReference.referencedElement",
                to: :element_reference_referenced_element
