...
require_relative "guardexpression"
require_relative "guardtransition"
...
class Guard < Shale::Mapper
  ...
  attribute :guard_expression, Guardexpression, collection: true
  ...
  attribute :guard_transition, Guardtransition, collection: true
  ...
  xml do
    ...
    map_element "Guard.expression", to: :guard_expression
    ...
    map_element "Guard.transition", to: :guard_transition
