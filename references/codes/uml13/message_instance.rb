...
class MessageInstance < Shale::Mapper
  ...
  attribute :message_instance_specification, MessageInstancespecification,
            collection: true
  attribute :message_instance_sender, MessageInstancesender, collection: true
  attribute :message_instance_receiver, MessageInstancereceiver,
            collection: true
  attribute :message_instance_argument, MessageInstanceargument,
            collection: true
  ...
  xml do
    ...
    map_element "MessageInstance.specification",
                to: :message_instance_specification
