...
module CityGmlShared
  ...
  INSTANCES = [
    [:application_schema, :base_package, "EAPK_1C8607D1_2967_44ff_948A_2A9256D00A45"],
    ...
    [:top_level_feature_type, :base_class, "EAID_645EA139_9F9D_4caf_90C3_3455836FA55B"],
...
module Iso19103Shared
  ...
  INSTANCES = [
    [:abstract_schema, :base_package, "EAPK_63F21616_57B0_4ffc_A785_8FB5B49C27F1"],
    [:gi_interface, :base_interface, "EAID_1EA35B7C_1E09_4fe5_B75D_515CA12171B9"],
    [:gi_property, :base_property, "EAID_2A7400AC_F474_4063_A5B9_5C5305020D60"],
    [:gi_enumeration, :base_enumeration, "EAID_5AC15946_7E2E_4d2e_8208_300138B764C9"],
    [:gi_enumeration_literal, :base_enumeration_literal, "EAID_44EAA54D_A02D_4263_9EBF_C67721A40BAA"],
  ].freeze
end
